...
--
-- Host: anchanto-sus-stg-v8.cbudzbiqnbgm.ap-southeast-1.rds.amazonaws.com    Database: dbSelluSeller
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=16619837 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `ati_item_assets` (
  ...
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=996125 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1152260 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=30968 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `backup_marketplace_products`
--

DROP TABLE IF EXISTS `backup_marketplace_products`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `backup_marketplace_products` (
  `id` int NOT NULL AUTO_INCREMENT,
  `currency` varchar(5) COLLATE utf8_unicode_ci DEFAULT NULL,
  `marketplace_code` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `ts_ver` timestamp NOT NULL DEFAULT '2019-01-01 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `index_mpc_marketplace_products_on_state` (`state`),
  KEY `index_mpc_marketplace_products_on_seller_marketplace_id` (`seller_marketplace_id`),
  KEY `mp_products_parent_id` (`parent_id`),
  KEY `mpc_mp_products_product_id` (`product_id`)
...
CREATE TABLE `backup_products` (
  ...
  `base_currency` varchar(5) COLLATE utf8_unicode_ci DEFAULT NULL,
  `price` decimal(15,2) DEFAULT '0.00',
  `selling_price` decimal(15,2) DEFAULT '0.00',
  `number_of_marketplaces` int DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `index_mpc_products_on_seller_id` (`seller_id`),
  KEY `index_mpc_products_on_inventory_product_id` (`inventory_product_id`),
  KEY `index_mpc_products_on_collection_id` (`collection_id`),
  KEY `product_inventory_product_id` (`inventory_product_id`),
  KEY `products_sku_seller_id_x` (`sku`,`seller_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2244232 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `bak_mpc_error_reports_01072020`
--

DROP TABLE IF EXISTS `bak_mpc_error_reports_01072020`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bak_mpc_error_reports_01072020` (
  `id` int NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `bak_mpc_error_reports_09_dec_19`
--

DROP TABLE IF EXISTS `bak_mpc_error_reports_09_dec_19`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bak_mpc_error_reports_09_dec_19` (
  `id` int NOT NULL AUTO_INCREMENT,
  `seller_marketplace_id` int DEFAULT NULL,
  `error_message` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `error_hash` text COLLATE utf8mb4_general_ci,
...
--
-- Table structure for table `bak_mpc_error_reports_29_04`
--

DROP TABLE IF EXISTS `bak_mpc_error_reports_29_04`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bak_mpc_error_reports_29_04` (
  `id` int NOT NULL AUTO_INCREMENT,
  `seller_marketplace_id` int DEFAULT NULL,
  `error_message` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `error_hash` text COLLATE utf8mb4_general_ci,
...
) ENGINE=InnoDB AUTO_INCREMENT=55005 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `inactive_sellers`
--

DROP TABLE IF EXISTS `inactive_sellers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `inactive_sellers` (
  `archival_period` varchar(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `seller_id` int NOT NULL DEFAULT '0',
  `seller_country` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `seller_updated_at` datetime NOT NULL,
  ...
  `subscription_updated_at` datetime NOT NULL,
  `channels_connected` int NOT NULL DEFAULT '0',
  `src_shard_id` int DEFAULT NULL,
  `dest_shard_id` int DEFAULT NULL,
  `inv_products_count` int NOT NULL DEFAULT '0',
  `products_count` int NOT NULL DEFAULT '0',
  `orders_count` int NOT NULL DEFAULT '0',
  `inv_products_deleted` int NOT NULL DEFAULT '0',
...
) ENGINE=InnoDB AUTO_INCREMENT=138644339 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `mpc_addresses_09NOV2020`
--

DROP TABLE IF EXISTS `mpc_addresses_09NOV2020`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mpc_addresses_09NOV2020` (
  `id` int NOT NULL AUTO_INCREMENT,
  `firstname` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lastname` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `address1` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `state_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `alternative_phone` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `company` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `state_id` int DEFAULT NULL,
  `country_id` int DEFAULT NULL,
  ...
  KEY `ix_addresses_lastname` (`lastname`),
  KEY `ix_addresses_phone` (`phone`)
) ENGINE=InnoDB AUTO_INCREMENT=131899934 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `mpc_addresses_tmp`
--

DROP TABLE IF EXISTS `mpc_addresses_tmp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mpc_addresses_tmp` (
  `id` int NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB AUTO_INCREMENT=95590652 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `mpc_base_categories` (
  ...
  `ts_ver` timestamp NOT NULL DEFAULT '2019-01-01 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=29032 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1691127 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=361153 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2179092 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=79384 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=22306103 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `mpc_category_commissions` (
  ...
  CONSTRAINT `fk_rails_b43d94a1da` FOREIGN KEY (`taxon_id`) REFERENCES `mpc_taxons` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
) ENGINE=InnoDB AUTO_INCREMENT=24927 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=8291 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=209366 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `mpc_credential_keys_18_oct`
--

DROP TABLE IF EXISTS `mpc_credential_keys_18_oct`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mpc_credential_keys_18_oct` (
  `id` int NOT NULL AUTO_INCREMENT,
  `value` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `seller_marketplace_id` int NOT NULL,
  `created_at` datetime NOT NULL,
  ...
  KEY `index_mpc_credential_keys_on_seller_marketplace_id` (`seller_marketplace_id`),
  KEY `mpc_credential_keys` (`marketplace_key_id`)
) ENGINE=InnoDB AUTO_INCREMENT=82996 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=137796753 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=58770132 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=15646492 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `mpc_error_reports` (
  ...
  PRIMARY KEY (`id`),
  KEY `error_report_smp_id` (`seller_marketplace_id`)
) ENGINE=InnoDB AUTO_INCREMENT=118568315 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `mpc_error_reports_bak`
--

DROP TABLE IF EXISTS `mpc_error_reports_bak`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mpc_error_reports_bak` (
  `id` int NOT NULL AUTO_INCREMENT,
  `seller_marketplace_id` int DEFAULT NULL,
  `error_message` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `error_hash` text COLLATE utf8mb4_general_ci,
...
--
-- Table structure for table `mpc_error_reports_bak_28_may_18`
--

DROP TABLE IF EXISTS `mpc_error_reports_bak_28_may_18`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mpc_error_reports_bak_28_may_18` (
  `id` int NOT NULL AUTO_INCREMENT,
  `seller_marketplace_id` int DEFAULT NULL,
  `error_message` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `error_hash` text COLLATE utf8mb4_unicode_ci,
  `source_api` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ts_ver` timestamp NOT NULL DEFAULT '2019-01-01 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=58005026 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `mpc_event_logs_bk1004`
--

DROP TABLE IF EXISTS `mpc_event_logs_bk1004`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mpc_event_logs_bk1004` (
  `id` int NOT NULL AUTO_INCREMENT,
  `event_type` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `event_time` datetime NOT NULL,
  `event_source` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `event_env` varchar(128) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `event_log` text COLLATE utf8mb4_general_ci,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `index_mpc_event_logs_on_event_type` (`event_type`),
...
) ENGINE=InnoDB AUTO_INCREMENT=215126935 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=201393099 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=527423 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=232596886 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `mpc_field_values_1809`
--

DROP TABLE IF EXISTS `mpc_field_values_1809`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mpc_field_values_1809` (
  `id` int NOT NULL AUTO_INCREMENT,
  `field_id` int DEFAULT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `index_field_values_field_id` (`field_id`)
) ENGINE=InnoDB AUTO_INCREMENT=34936505 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5944150 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `mpc_fields_1809`
--

DROP TABLE IF EXISTS `mpc_fields_1809`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mpc_fields_1809` (
  `id` int NOT NULL AUTO_INCREMENT,
  `marketplace_id` int DEFAULT NULL,
  ...
  KEY `mpc_field_m_id_t_id_fc_x` (`taxon_id`,`marketplace_id`,`field_code`),
  KEY `mpc_fields_parent_id` (`parent_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1864941 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `mpc_fields_bak`
--

DROP TABLE IF EXISTS `mpc_fields_bak`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mpc_fields_bak` (
  `id` int NOT NULL DEFAULT '0',
  `marketplace_id` int DEFAULT NULL,
  `field_type` varchar(45) CHARACTER SET latin1 NOT NULL,
  `data_type` varchar(45) CHARACTER SET latin1 NOT NULL,
  `mandatory` tinyint(1) NOT NULL DEFAULT '0',
  `free_text` tinyint(1) NOT NULL DEFAULT '0',
  `taxon_id` int DEFAULT NULL,
  `field_name` varchar(255) CHARACTER SET latin1 NOT NULL,
  `field_code` varchar(255) CHARACTER SET latin1 NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  `option_type` tinyint(1) DEFAULT '0',
  `ts_ver` timestamp NOT NULL DEFAULT '2019-01-01 00:00:00' ON UPDATE CURRENT_TIMESTAMP
...
--
-- Table structure for table `mpc_fields_bak_19_12`
--

DROP TABLE IF EXISTS `mpc_fields_bak_19_12`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mpc_fields_bak_19_12` (
  `id` int NOT NULL AUTO_INCREMENT,
  `marketplace_id` int DEFAULT NULL,
  `field_type` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
  `data_type` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  KEY `mpc_field_m_id_t_id_fc_x` (`taxon_id`,`marketplace_id`,`field_code`),
  KEY `mpc_fields_parent_id` (`parent_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3532066 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `mpc_fields_mb4_bak`
--

DROP TABLE IF EXISTS `mpc_fields_mb4_bak`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mpc_fields_mb4_bak` (
  `id` int NOT NULL AUTO_INCREMENT,
  `marketplace_id` int DEFAULT NULL,
  `field_type` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
  `data_type` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  KEY `index_fields_marketplace_id` (`marketplace_id`),
  KEY `index_fields_taxon_id` (`taxon_id`),
  KEY `field_code_uniq_x` (`field_code`(191)),
  KEY `mpc_field_m_id_t_id_fc_x` (`taxon_id`,`marketplace_id`,`field_code`(191)),
  KEY `mpc_fields_parent_id` (`parent_id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `mpc_ftp_attachments` (
  ...
  `ts_ver` timestamp NOT NULL DEFAULT '2019-01-01 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=35620 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `mpc_fulfilment_centers` (
  ...
  CONSTRAINT `fk_rails_0f30a44e89` FOREIGN KEY (`address_id`) REFERENCES `mpc_addresses_tmp` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
) ENGINE=InnoDB AUTO_INCREMENT=52105 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=86084 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=14879 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=43481 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=40005 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=376067 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=47112 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=54832 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=24771 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=571993 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
